  ...
  <<-END
    ...
    <body>
      ...
      <script type="text/javascript">
        ...
        (function(d) {
          var js, id = 'infusionsoft-jssdk'; if (d.getElementById(id)) {return;}
          js = d.createElement('script'); js.id = id; js.async = true;
          js.src = "//connect.infusionsoft.net/en_US/all.js";
          ...
          $('a').click(function(e) {
            ...
            FB.login(function(response) {
              if (response.authResponse) {
                $('#connect').html('Connected! Hitting OmniAuth callback (GET /auth/infusionsoft/callback)...');

                // since we have cookies enabled, this request will allow omniauth to parse
                // out the auth code from the signed request in the fbsr_XXX cookie
                $.getJSON('/auth/infusionsoft/callback', function(json) {
